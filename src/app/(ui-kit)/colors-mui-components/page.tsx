            ...
            <div className="container mx-auto px-4">
                    ...
                    <div className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap gap-2">
                                <Button variant="contained" color="primary" className="shadow-sm">Primary</Button>
                                <Button variant="contained" color="secondary" className="shadow-sm">Secondary</Button>
                                <Button variant="contained" color="error" className="shadow-sm">Error</Button>
                                <Button variant="contained" color="warning" className="shadow-sm">Warning</Button>
                                <Button variant="contained" color="success" className="shadow-sm">Success</Button>
                                <Button variant="contained" color="info" className="shadow-sm">Info</Button>
                            </div>
                        </div>
                ...
                <Paper className="p-6 shadow-md rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <Typography variant="subtitle1" className="mb-2 font-medium text-gray-800">
                                MUI Typography
                            </Typography>
                        ...
                        <div>
                            <h3 className="text-base font-medium mb-2 text-gray-800">Tailwind Text Colors</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <FormControl fullWidth className="mb-4">
                                <InputLabel id="demo-simple-select-label" className="text-gray-700">Age</InputLabel>
                                <Select
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                <Card className="shadow-md hover:shadow-lg transition-shadow duration-200">
                                    <CardContent>
                                        ...
                                        <Typography variant="body2" className="text-gray-600">
                                            This is a MUI card with Tailwind classes for styling. It demonstrates
                                            how both libraries can be used together effectively.
                                        </Typography>
                                    </CardContent>
                                    <CardActions className="bg-gray-50 px-4 py-2">
                                        <Button size="small" className="text-primary-600 hover:text-primary-800">
                                            Learn More
                                        </Button>
                                        <Button size="small" className="text-secondary-600 hover:text-secondary-800">
                                            Share
                                        </Button>
                                    </CardActions>
                                </Card>
                                ...
                                <Card className="shadow-md hover:shadow-lg transition-shadow duration-200 border-l-4 border-secondary-500">
                                    <CardContent>
                                        <Typography variant="h6" className="text-secondary-700 mb-2">
                                            Featured Card
                                        </Typography>
                                        <Typography variant="body2" className="text-gray-600">
                                    ...
                                    <CardActions className="bg-gray-50 px-4 py-2">
                                        <Button size="small" className="bg-secondary-500 hover:bg-secondary-600 text-white px-4 py-1 rounded">
                                            Action
                                        </Button>
                                    </CardActions>
                                </Card>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <div className="bg-error-50 text-error-900 p-4 rounded-lg border-l-4 border-error-500">
                                ...
                                <p className="text-sm mt-1">This is an example of an error alert using the error color palette.</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="bg-warning-50 text-warning-900 p-4 rounded-lg border-l-4 border-warning-500">
                                ...
                                <p className="text-sm mt-1">This is an example of a warning alert using the warning color palette.</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="bg-info-50 text-info-900 p-4 rounded-lg border-l-4 border-info-500">
                                ...
                                <p className="text-sm mt-1">This is an example of an info alert using the info color palette.</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="bg-success-50 text-success-900 p-4 rounded-lg border-l-4 border-success-500">
                                ...
                                <p className="text-sm mt-1">This is an example of a success alert using the success color palette.</p>
                            </div>
                        </div>
                    </div>
                </Paper>
