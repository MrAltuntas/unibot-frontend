    ...
    return (
        <div className="socket-container p-4 max-w-xl mx-auto">
            ...
            <div className="h-80 mb-4 border rounded overflow-y-auto p-3 bg-white">
                {!currentRoom ? (
                    <p className="text-gray-500 text-center">Join a room to start chatting</p>
                ) : messages.length === 0 ? (
                    ...
                    messages.map((msg, index) => (
                        <div key={index} className={`mb-2 p-2 rounded ${
                            ...
                            {msg.type === 'system' ? (
                                ...
                                <>
                                    <div className={`font-bold ${msg.type === 'bot' ? 'text-yellow-600 flex items-center' : ''}`}>
            ...
            <form onSubmit={sendMessage} className="flex">
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-r font-medium ${
                        (connected && currentRoom) ? 'bg-blue-500 text-white' : 'bg-gray-400 text-gray-700'
                    }`}
                >
                    Send
                </button>
