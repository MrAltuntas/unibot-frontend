      ...
      <section id="features" className="py-16 bg-gray-50">
        <div className="container mx-auto text-center">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
              <BoltIcon className="h-8 w-8 text-blue-500 mx-auto" />
              <h3 className="mt-2 text-xl font-semibold text-blue-600">
                Instant Responses
              </h3>
              <p className="mt-2 text-gray-500">
            ...
            <div className="p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
              <UserCircleIcon className="h-8 w-8 text-blue-500 mx-auto" />
              <h3 className="mt-2 text-xl font-semibold text-blue-600">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <Disclosure key={index}>
                <DisclosureButton className="w-full text-left bg-white rounded-lg shadow-md py-3 px-4 flex items-center justify-between hover:bg-gray-100 transition-colors duration-200">
                  <span className="text-gray-800 font-medium">
                    {faq.question}
                  </span>
                  <QuestionMarkCircleIcon className="h-5 w-5 text-gray-500" />
                </DisclosureButton>
                <DisclosurePanel className="px-4 pt-2 pb-4 bg-gray-50 rounded-b-lg">
